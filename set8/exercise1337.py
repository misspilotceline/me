# -*- coding: UTF-8 -*- python3 ../course/set8/tests.py
"""
I'm in UR exam.
...
def pet_filter(letter="a") -> List:
    ...
    # fmt: on
    filtered = [pet for pet in pets if letter.lower() in pet]
...
def best_letter_for_pets() -> str:
    ...
    for letter in the_alphabet:
        ...
        if len(pets_with_letter) > most_pets:
            most_pets = len(pets_with_letter)
